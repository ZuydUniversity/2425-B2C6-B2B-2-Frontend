...
import styles from './FinancialAdminPage.module.css'; // Pas dit pad aan indien nodig
    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.card}>
            {/* Hier is de wijziging: Gebruik de nieuwe CSS class `styles.profitValue` */}
            <p className={styles.cardLabel}>Winst/Verlies:</p>
            <p className={`${styles.cardValue} ${styles.profitValue}`}>€ ____</p>
          </div>
        </div>
      </section>
    </div>
